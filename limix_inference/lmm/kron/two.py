...
#     """
#
#     def __init__(self, Y, Cg, Cn, F=None, A=None, R=None):
#         """
#         Args:
#             Y:      [N, P] phenotype matrix
...
#     #     SroCdLW = SrdLWtC.swapaxes(1,2).reshape((self.mean._N * self.mean._P,
#     #                               self.mean.n_covs), order = 'F')
