...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit__arr_liknorm(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit__arr_liknorm(void) { return NULL; }
#  else
     init_arr_liknorm(void) { }
#  endif
#  endif
#elif PY_MAJOR_VERSION >= 3
PyMODINIT_FUNC
PyInit__arr_liknorm(void)
{
  return _cffi_init("_arr_liknorm", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
init_arr_liknorm(void)
{
  _cffi_init("_arr_liknorm", 0x2601, &_cffi_type_context);
}
#endif
